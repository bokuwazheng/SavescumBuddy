...
{
    public class HotkeyListener : IHotkeyListener<Keys>
    {
        #region TYPES
        ...
        private class KeyEventArgs : IKeyEventArgs<Keys>
        {
            private System.Windows.Forms.KeyEventArgs _args;

            public KeyEventArgs(Keys keyData)
            {
                _args = new System.Windows.Forms.KeyEventArgs(keyData);
            }
            
            public Keys KeyCode => _args.KeyCode;
            public bool SuppressKeyPress => _args.SuppressKeyPress;
            public bool Handled => _args.Handled;
        }

        #endregion // CLASS KeyEventArgs

        #region KeyPressEventArgs

        private class KeyPressEventArgs : IKeyPressEventArgs<Keys>
        {
            private System.Windows.Forms.KeyPressEventArgs _args;

            public KeyPressEventArgs(char keyChar)
            {
                _args = new System.Windows.Forms.KeyPressEventArgs(keyChar);
            }

            public char KeyChar => _args.KeyChar;
            public bool Handled => _args.Handled;
        }

        #endregion // CLASS KeyPressEventArgs
        ...
        /// </summary>
        public event EventHandler<IKeyEventArgs<Keys>> KeyDown;
        /// <summary>
        /// Occurs when a key is released.
        /// </summary>
        public event EventHandler<IKeyEventArgs<Keys>> KeyUp;
        /// <summary>
        /// Occurs when a character key is pressed.
        /// </summary>
        public event EventHandler<IKeyPressEventArgs<Keys>> KeyPress;
        ...
        protected virtual void OnKeyDown(IKeyEventArgs<Keys> kea)
        {
            if (KeyDown != null)
                KeyDown(this, kea);
        }
        ...
        /// </summary>
        /// <param name="kea"> KeyEventArgs </param>
        protected virtual void OnKeyUp(IKeyEventArgs<Keys> kea)
        {
            if (KeyUp != null)
                KeyUp(this, kea);
        }
        ...
        /// </summary>
        /// <param name="kea"> KeyEventArgs </param>
        protected virtual void OnKeyPress(IKeyPressEventArgs<Keys> kpea)
        {
            if (KeyPress != null)
                KeyPress(this, kpea);
        }
        ...
        int HookCallbackProcedure(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if (nCode > -1 && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                // Create KeyEventArgs 
                IKeyEventArgs<Keys> kea = new KeyEventArgs((Keys)(khs.vkCode |
                ...
                if (wParam == WM_KEYDOWN && !bHandled && !kea.SuppressKeyPress)
                {
                    ...
                    if (ToAscii(khs.vkCode, khs.scanCode, abyKeyState, abyInBuffer, khs.flags) == 1)
                    {
                        ...
                        IKeyPressEventArgs<Keys> kpea = new KeyPressEventArgs(chKey);
                        OnKeyPress(kpea);
                        bHandled = kea.Handled;
                    }
                }
